...
-- MAGIC %python
-- MAGIC dir = DA.paths.datasets + "/ecommerce/raw/events-historical"
-- MAGIC dbutils.fs.ls(dir)
-- MAGIC dir = "dbfs:/mnt/dbacademy-users/michaelpopp42@gmail.com/data-engineering-with-databricks/database.db/events"
-- MAGIC dbutils.fs.ls(dir)
-- MAGIC dir = "dbfs:/mnt/dbacademy-users/michaelpopp42@gmail.com/data-engineering-with-databricks/database.db/sales"
-- MAGIC dbutils.fs.ls(dir)
-- MAGIC dir = DA.paths.datasets + "/ecommerce/raw/sales-30m"
-- MAGIC dbutils.fs.ls(dir)
