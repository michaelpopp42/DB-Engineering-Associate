...
dbutils.fs.ls('dbfs:/mnt/dbacademy-users/michaelpopp42@gmail.com/data-engineering-with-databricks/database.db/bronze')
...
# MAGIC %sql
# MAGIC DESCRIBE EXTENDED device_counts;
# MAGIC 
...
# MAGIC %sql
# MAGIC 
# MAGIC DESCRIBE HISTORY device_counts
