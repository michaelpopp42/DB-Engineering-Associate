...
-- MAGIC %python
-- MAGIC display(spark.sql(f"SHOW DATABASES"))
...
DROP VIEW global_temp.celsius_global;
SHOW TABLES IN global_temp;

--SELECT * FROM global_temp.celsius_global ;
--SELECT * FROM celsius_temp 
--use da_michaelpopp42_9347_dewd;
--SHOW TABLES;
...
USE da_michaelpopp42_9347_dewd;
SHOW TABLES;
DROP DATABASE da_michaelpopp42_9347_dewd CASCADE
