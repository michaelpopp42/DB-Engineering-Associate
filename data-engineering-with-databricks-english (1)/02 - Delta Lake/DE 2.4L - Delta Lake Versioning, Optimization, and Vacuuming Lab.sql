...
-- MAGIC %python
-- MAGIC #SELECT CAST(SUM(grams) AS INT) FROM pre_delete_vw
...
-- MAGIC last_tx
-- MAGIC last_tx["operation"]
-- MAGIC type(last_tx["operationParameters"])
-- MAGIC op_parms = last_tx["operationParameters"]
-- MAGIC op_parms['zOrderBy']
